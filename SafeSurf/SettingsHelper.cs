...
namespace SCTV
{
  ...
  class SettingsHelper
  {
    ...
    /// <summary>
    /// Gets or sets a value indicating if we should check the pages for forms
    /// </summary>
    public bool CheckForms
    {
        get { return _mySettings.CheckForms; }
        set { _mySettings.CheckForms = value; }
    }
