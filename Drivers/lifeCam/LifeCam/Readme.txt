...
- Installation can be blocked by a virus-protection, a pop-up-blocker, or a spyware-detection program. (For more information, see 1.3.)
...
4.5  "Error in starting audio preview" and "Error in starting filter graph".

On Windows Vista N and KN versions, using Amcap, you may receive the following messages when starting a video call:
"Error in starting audio preview" 
and 
"Error in starting filter graph".
...
4.6  "This computer has no sound recording capabilities for Skype".

On Windows Vista N and KN versions, using Skype, you may receive the following messages when starting a video call:
"This computer has no sound recording capabilities for Skype".
