...
namespace SCTVCamera
{
    ...
    /// </summary>
    public class SCTVCameraWindow : System.Windows.Forms.Form
    {
        // statistics
        ...
        private SCTVCamera.CameraWindow cameraWindow;
        ...
        public SCTVCameraWindow()
        {
            ...
            //open camera if there is only one
            if(form.Device != null)
            {
                // create video source
            ...
            //if (form.Cameras.Count > 0)
            //{
            //    string foundDevices = "";

            //    foreach (Filter camera in form.Cameras)
            //    {
            //        foundDevices += camera.Name + Environment.NewLine;

            //        // create video source
            //        CaptureDevice localSource = new CaptureDevice();
            //        localSource.VideoSource = camera.MonikerString;
                    
            //        // open it
            //        OpenVideoSource(localSource);
            //    }

            //    //MessageBox.Show("Devices " + foundDevices);
            //}
        }

        public void CreateCamera(Filter camera)
        {
            // create video source
            CaptureDevice localSource = new CaptureDevice();
            localSource.VideoSource = camera.MonikerString;
        ...
        private void InitializeComponent( )
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SCTVCameraWindow));
            ...
            this.cameraWindow = new SCTVCamera.CameraWindow();
            ...
            this.panel.Size = new System.Drawing.Size(408, 196);
            ...
            this.cameraWindow.Size = new System.Drawing.Size(404, 192);
        ...
        //static void Main()
        //{
        //    Application.Run(new SCTVCameraWindow());
        //}
